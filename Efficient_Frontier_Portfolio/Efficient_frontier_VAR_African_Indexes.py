...
#dataframe creation
file=ExcelFile(r'C:\Users\ludov\Documents\Python\efficient frontier portfolio\docs and code\index_portfolio.xlsx')
df=file.parse('Data')
...
def display_simulated_ef_with_random(mean_returns, cov_matrix, num_portfolios, risk_free_rate):
    ...
    print ("-"*80)
    print ("Allocations du portefeuille de maximisation du Sharpe Ratio \n")
    print ("rendement annualisé:", round(rp,2))
    print ("volatilité annualisée:", round(sdp,2))
    print ("\n")
    print (max_sharpe_allocation)
    print ("-"*80)
    print ("Allocations du portefeuille de minimisation de la volatilité\n")
    ...
    plt.colorbar()
    plt.scatter(sdp,rp,marker='*',color='r',s=500, label='Maximum du Sharpe ratio')
    plt.scatter(sdp_min,rp_min,marker='*',color='g',s=500, label='Minimum de volatilité')
    plt.title('Simulation d`optimisation de portefeuille basée sur la frontière efficiente')
